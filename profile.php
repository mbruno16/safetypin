...
if (isset($_GET['username'])) {
        if (DB::query('SELECT username FROM users WHERE username=:username', array(':username'=>$_GET['username']))) {
                ...
                $email = DB::query('SELECT email FROM users WHERE username=:username', array(':username'=>$_GET['username']))[0]['email'];
...
<head>
    ...
    <title>Safety Pin | <?php echo $fullname; ?>'s Profile</title>
    <meta
      name="description"           
...
<body onload="animatedCursor();">
    ...
    <div>
        <div class="container">
            <h1><?php echo $fullname; ?>'s Profile <?php if ($verified) { echo '<i class="glyphicon glyphicon-ok-sign verified" data-toggle="tooltip" title="Verified User" style="font-size:28px;color:#e61c5d;"></i>'; } ?></h1>

            <div class="row">
                <div class="col-md-3">
                    <ul class="list-group">
                        <li class="list-group-item" style="margin-bottom:30px; border-radius:10px; padding-bottom:0px;"><span><strong>Welcome to <?php echo $fullname; ?>'s Profile</strong></span>
                            <p><br>Username: @<?php echo $username; ?></p>
                            <p>Contact Number: <?php echo $phonenumber; ?> <a href="tel:'<?php echo $phonenumber; ?>'"><i class="glyphicon glyphicon-earphone" style="display:inline; float: right; font-size:15px;"></i></a></p>
                            <p>Email Address: <?php echo $email; ?> <a href="mailto:<?php echo $email; ?>"><i class="glyphicon glyphicon-envelope" style="display:inline; float: right; font-size:15px;"></i></a></p>
                        </li>
                    </ul>
                </div>
                <div class="col-md-6">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Tag Authorities</h4></div>
                        ...
                        foreach($authorities as $a){
                            echo '<div style="max-height: 350px; overflow-y:auto; position:relative; padding:15px; border-bottom: 1px solid #E5E5E5;">
                            <input type="checkbox" name="authority" value="@'.$a['username'].'">
                            <a href="https://safety-pin.ga/profile.php?username='.$a['username'].'" target="_blank" rel="noopener noreferrer"><label for="" style="font-weight:normal; font-size: 16px">'.$a['fullname'].' <i class="glyphicon glyphicon-ok-sign verified" data-toggle="tooltip" title="Verified User" style="font-size:16px;color:#e61c5d;"></i></label></a>
                            </div>';
                        }
                        ?>
...
*/
    ...
    var aTag = $(aid);
        ...
        $(document).ready(function() {
            ...
            var followerID = "<?php echo Login::isLoggedIn(); ?>";
            var x = document.getElementById("post_button");
            x.style.display = "none";
